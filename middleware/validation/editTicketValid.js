const createTicketValid = function(req, res, next) {
    ...
    if ((req.body.currentUser && req.body.currentUser.isAdmin) && req.body.ticket.status.name !== req.body.status.name) {
        Error.status = 'You dont have permissions to carry out this edit';
    }

    if ((req.body.currentUser && req.body.currentUser.isAdmin) && req.body.ticket.info !== req.body.info) {
